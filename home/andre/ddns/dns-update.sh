...
logfile='/var/log/dns-update.log'
# Where to save log file. You may want to set up logrotate (leave empty to disable logging)
cachedir='/var/cache/dns-update'				
# Directory where script saves DNS address
zone_id='071365beaa2f2c4cd65d8fbc5378f37d'									
# From CloudFlare Overview page
api_token='Pw5mzwGVHMePsHkHiKwUmlQHj7rwAe6Kdns_hSsF'
