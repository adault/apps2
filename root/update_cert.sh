...
if [ "$MOD_DATE" == "$TODAY" ]; then
    ...
    scp /etc/letsencrypt/live/dault.ca/privkey.pem root@192.168.1.1:/data/unifi-core/config/unifi-core.key
    scp /etc/letsencrypt/live/dault.ca/fullchain.pem root@192.168.1.1:/data/unifi-core/config/unifi-core.crt
    ssh root@192.168.1.1 chmod a+r /data/unifi-core/config/unifi-core.crt
